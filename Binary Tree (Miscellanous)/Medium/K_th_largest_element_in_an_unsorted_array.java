...
public class K_th_largest_element_in_an_unsorted_array {
    ...
    public static void main(String[] args) {
        K_th_largest_element_in_an_unsorted_array obj =
                new K_th_largest_element_in_an_unsorted_array();

        int[] nums = {3, 2, 1, 5, 6, 4};
        int k = 2;

        System.out.println(obj.kthLargestElement(nums, k)); // 5
    }
}
